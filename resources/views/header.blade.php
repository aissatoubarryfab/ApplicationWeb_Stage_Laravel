...
<div id="navi">
    <nav class="nav nav-pills nav-fill">
        <a class="nav-link  nav-item" href="/">Accueil</a>  
                 <a class="nav-link nav-item" href="contacter">Contact</a>
            <a class="nav-link nav-item" href="/stage">Ajouter une offre</a>
        <a class="nav-link nav-item" href="/consulter">Consulter les candidatures</a>
